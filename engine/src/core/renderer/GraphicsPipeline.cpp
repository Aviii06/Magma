...
namespace Magma
{
        ...
        VkFormat depthAttachmentFormat)
    {
        ...
        // Vertex input state - no vertex buffers for now (hardcoded triangle)
        ...
        depthStencil.depthTestEnable = depthAttachmentFormat != VK_FORMAT_UNDEFINED ? VK_TRUE : VK_FALSE;
        depthStencil.depthWriteEnable = depthAttachmentFormat != VK_FORMAT_UNDEFINED ? VK_TRUE : VK_FALSE;
        depthStencil.depthCompareOp = VK_COMPARE_OP_LESS_OR_EQUAL;
        depthStencil.depthBoundsTestEnable = VK_FALSE;
        depthStencil.stencilTestEnable = VK_FALSE;

        // Dynamic rendering info (Vulkan 1.3 / VK_KHR_dynamic_rendering)
        ...
        {
            Logger::Log(LogLevel::ERROR, "Failed to create graphics pipeline");
